...
//*
// Response: Reply with random data generated by exinternal RNG
// @end
type Entropy struct {
...
//*
// Request: Load seed and related exinternal settings from the computer
// @start
// @next Success
// @next Failure
...
// Its position is shown only on device's exinternal display.
// @next WordAck
