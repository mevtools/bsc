...
type wallet struct {
	...
	// lock can be used to protect the wallet's software-side exinternal state, which
...
// close is the exinternal wallet closer that terminates the USB connection and
